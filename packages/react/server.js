...
const templateHtml = prod ? await readFile("./dist/react/index.html", "utf-8") : "";
...
app.use("*all", async (req, res) => {
  try {
    ...
    if (!prod) {
      ...
      template = await vite.transformIndexHtml(url, await readFile("./index.html", "utf-8"));
...
(await vite.ssrLoadModule("./src/mocks/node.ts")).mswServer.listen({
